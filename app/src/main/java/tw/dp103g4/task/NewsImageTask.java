...
public class NewsImageTask extends AsyncTask<Object, Integer, Bitmap> {
    private static final String TAG = "TAG_CoverImageTask";
    private String url;
    private int id, imageSize;
    private WeakReference<ImageView> imageViewWeakReference;

    public NewsImageTask(String url, int id, int imageSize) {
        this(url, id, imageSize, null);
    }

    public NewsImageTask(String url, int id, int imageSize, ImageView imageView) {
        this.url = url;
        this.id = id;
