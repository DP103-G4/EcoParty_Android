...
public class AfterImageTask extends AsyncTask<Object, Integer, Bitmap> {
    ...
    public AfterImageTask(String url, int id, int imageSize) {
        this(url, id, imageSize, null);
    }

    public AfterImageTask(String url, int id, int imageSize, ImageView imageView) {
        this.url = url;
        this.id = id;
    ...
    protected Bitmap doInBackground(Object... objects) {
        ...
        jsonObject.addProperty("action", "getAfterImg");
